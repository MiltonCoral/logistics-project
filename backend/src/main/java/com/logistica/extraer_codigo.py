...
if __name__ == "__main__":
    ...
    RUTA_DEL_PROYECTO = "/Users/edi/Documents/Trabajo/backend S.A/backend/src/main/java/com/logistica" 
    
    # 2. Nombre del archivo de texto que se va a generar
    ARCHIVO_DE_SALIDA = "codigo_backendjava.txt"
