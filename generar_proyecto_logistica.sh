...
# ============================================================
# Script de Generación - Backend Sistema de Gestión Documental Logística
# Genera toda la estructura de carpetas y archivos fuente
# ============================================================

set -e

PROJECT_NAME="logistica-api"
...
mkdir -p "${BASE_DIR}/src/main/java/com/logistica/config"
mkdir -p "${BASE_DIR}/src/main/java/com/logistica/controller"
mkdir -p "${BASE_DIR}/src/main/java/com/logistica/dao"
mkdir -p "${BASE_DIR}/src/main/java/com/logistica/model"
mkdir -p "${BASE_DIR}/src/main/java/com/logistica/security"
mkdir -p "${BASE_DIR}/src/main/java/com/logistica/service"
...
# ============================================================
cat << 'EOF' > "${BASE_DIR}/src/main/resources/application.properties"
server.port=8080
...
# ============================================================
# 5. LogisticaApiApplication.java
# ============================================================
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/LogisticaApiApplication.java"
...
# 6.1 Usuario.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/model/Usuario.java"
...
# 6.2 Cliente.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/model/Cliente.java"
package com.logistica.model;
...
# 6.3 Checklist.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/model/Checklist.java"
package com.logistica.model;
...
# 6.4 Guia.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/model/Guia.java"
package com.logistica.model;
...
# 7.1 UsuarioDao.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/dao/UsuarioDao.java"
...
# 7.2 ClienteDao.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/dao/ClienteDao.java"
package com.logistica.dao;
...
# 7.3 ChecklistDao.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/dao/ChecklistDao.java"
package com.logistica.dao;
...
# 7.4 GuiaDao.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/dao/GuiaDao.java"
package com.logistica.dao;
...
# 8.1 JwtConfig.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/config/JwtConfig.java"
...
# 8.2 JwtUtil.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/security/JwtUtil.java"
...
# 8.3 JwtAuthenticationFilter.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/security/JwtAuthenticationFilter.java"
package com.logistica.security;
...
# 8.4 SecurityConfig.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/config/SecurityConfig.java"
package com.logistica.config;
...
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/service/AuthService.java"
...
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/controller/AuthController.java"
...
# 10.2 ClienteController.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/controller/ClienteController.java"
package com.logistica.controller;
...
# 10.3 ChecklistController.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/controller/ChecklistController.java"
package com.logistica.controller;
...
# 10.4 GuiaController.java
cat << 'EOF' > "${BASE_DIR}/src/main/java/com/logistica/controller/GuiaController.java"
package com.logistica.controller;
...
echo ""
echo "✅ Proyecto generado exitosamente en: ${BASE_DIR}/"
echo ""
echo "📂 Estructura generada:"
find "${BASE_DIR}" -type f | sort
echo ""
echo "🚀 Pasos siguientes:"
echo "   1. Configurar PostgreSQL y ejecutar database.sql"
echo "   2. Actualizar application.properties con tus credenciales"
echo "   3. Generar hashes BCrypt para los usuarios iniciales"
echo "   4. Ejecutar: cd ${BASE_DIR} && mvn spring-boot:run"
echo "   5. Probar con: ./test-api.sh"
